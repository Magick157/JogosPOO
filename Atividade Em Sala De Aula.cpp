	...
	*/
	...
	while (!sair)
	{
		...
		else
		{
			...
			cout << "<DIGITE PRIMEIRO NUMERO DO CODIGO NO TERMINAL> ";													//NOSSOS PRINTFS PARA RECECEBER OS NÚMEROS DIGITADOS PELO USER.
			cin >> codigo;
			...
			for(cont = 0; cont<=100; cont= cont + 10){														//CRIEI UM FOR PARA O CONTAR A PORCENTAGEM DO PERCENTUAL DE ACERTO DOS NOSSOS ACERTOS.
	...
	// ------ FAÇA UM LAÇO QUE COLOQUE 4 LINHAS EM TELA ------						//CRIEI UM FOR, PARA REPETIR A LINHA 4 VEZES.
	int linha;
	for(linha = 0; linha<=4; linha++){
		cout << "___________" << endl;
		
	}
	cout << "O codigo foi quebrado. Os arquivos finalmente sao seus." << endl;       //CRIEI UM FOR, PARA REPETIR A LINHA 4 VEZES.
...
void Mostrar_Circuito(bool cod1, bool cod2, bool cod3, bool cod4)
{
	/*	 ------ EXPLIQUE O QUE O IF ELSE ABAIXO FAZ NO PROGRAMA ------
		...
		SE A CONDIÇÃO 2 FOR VERDADEIRA, IRA IMPRIMIR NA TELA OS MEUS PRINTF's
		SE A CONDIÇÃO 2 NÃO FOR VERDADEIRA, IRÁ IMPRIMIR OQUE SE ENCONTRA DENTRO DO ELSE.
		SE A CONDIÇÃO 4 FOR VERDADEIRA, IRA IMPRIMIR NA TELA OS MEUS PRINTF's
		SE A CONDIÇÃO 4 NÃO FOR VERDADEIRA, IRÁ IMPRIMIR OQUE SE ENCONTRA DENTRO DO ELSE.
		SE A CONDIÇÃO 1 FOR VERDADEIRA, IRA IMPRIMIR NA TELA OS MEUS PRINTF's
		SE A CONDIÇÃO 1 NÃO FOR VERDADEIRA, IRÁ IMPRIMIR OQUE SE ENCONTRA DENTRO DO ELSE.
		SE A CONDIÇÃO 3 FOR VERDADEIRA, IRA IMPRIMIR NA TELA OS MEUS PRINTF's
		SE A CONDIÇÃO 3 NÃO FOR VERDADEIRA, IRÁ IMPRIMIR OQUE SE ENCONTRA DENTRO DO ELSE.
	*/
	if (cod2 == true)
	{
		cout << "	       ____	" << endl;
