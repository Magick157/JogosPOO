	...
	*/
	...
	while (!sair)
	{
		...
		else
		{
			...
			cout << "<DIGITE PRIMEIRO NUMERO DO CODIGO NO TERMINAL> ";													//RECEBE OS NUMEROS DIGITADOS PELO HACKER
			cin >> codigo;
			...
			for(cont = 0; cont<=100; cont= cont + 10){														//LAÇO PARA CONTAR O PERCENTUAL DE ACERTO DOS NUMEROS DIGITADOS
	...
	// ------ FAÇA UM LAÇO QUE COLOQUE 4 LINHAS EM TELA ------						//IRA REPETIR A LINHA 4 VEZES
	int linha;
	for(linha = 0; linha<=4; linha++){
		cout << "___________" << endl;
		
	}
	cout << "O codigo foi quebrado. Os arquivos finalmente sao seus." << endl;       //IRA REPETIR A LINHA 4 VEZES
...
void Mostrar_Circuito(bool cod1, bool cod2, bool cod3, bool cod4)
{
	/*	 ------ EXPLIQUE O QUE O IF ELSE ABAIXO FAZ NO PROGRAMA ------
		...
		SE A CONDIÇÃO 2 FOR VERDADEIRA, IRA IMPRIMIR NA TELA OS MEUS PRINTFS
		SE A CONDIÇÃO 2 NÃO FOR VERDADEIRA, IRÁ IMPRIMIR OQUE SE ENCONTRA DENTRO DO ELSE.
		SE A CONDIÇÃO 4 FOR VERDADEIRA, IRA IMPRIMIR NA TELA OS MEUS PRINTFS
		SE A CONDIÇÃO 4 NÃO FOR VERDADEIRA, IRÁ IMPRIMIR OQUE SE ENCONTRA DENTRO DO ELSE.
		SE A CONDIÇÃO 1 FOR VERDADEIRA, IRA IMPRIMIR NA TELA OS MEUS PRINTFS
		SE A CONDIÇÃO 1 NÃO FOR VERDADEIRA, IRÁ IMPRIMIR OQUE SE ENCONTRA DENTRO DO ELSE.
		SE A CONDIÇÃO 3 FOR VERDADEIRA, IRA IMPRIMIR NA TELA OS MEUS PRINTFS
